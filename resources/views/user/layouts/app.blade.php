...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center">
                    <img src="{{ asset('assets/user/imgs/theme/loading.gif') }}" alt="Loading Image" />
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('assets/user/js/plugins/slider-range.js') }}"></script>
    <script src="{{ asset('assets/user/js/plugins/jquery-ui.js') }}"></script>
    <script src="{{ asset('assets/user/js/plugins/custom-parallax.js') }}"></script>
    <script src="{{ asset('assets/user/js/plugins/leaflet.js') }}"></script>
    <script src="{{ asset('assets/user/js/plugins/TweenMax.min.js') }}"></script>
